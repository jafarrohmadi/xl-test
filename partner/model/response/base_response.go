...
// Success codes
var OrderSubmitted = ResponseCode{http.StatusCreated, "ORDER_SUBMITTED", "Order submitted successfully"}
...
var PaymentSuccess = ResponseCode{http.StatusOK, "PAYMENT_SUCCESS", "Payment processed"}
var WebhookAccepted = ResponseCode{http.StatusOK, "WEBHOOK_ACCEPTED", "Webhook processed"}
...
var Conflict = ResponseCode{http.StatusConflict, "CONFLICT", "Resource already exists"}
